...
Every macro-F1 in FINDINGS is measured against Qwen3.5-27B's pseudo-labels, and
nobody has ever measured how well those agree with a human on the six cue
classes. Without it there is no denominator: 0.479 could be 60% or 95% of what
