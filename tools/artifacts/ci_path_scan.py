...
matching docs/branch_c/RELEASE_RISK_REGISTER.md RISK 4's own classification
...
def main() -> int:
    ...
    if hits:
        ...
        for h in hits:
            print(f"  {h}")
        print(
            "\nSee docs/branch_c/RELEASE_RISK_REGISTER.md RISK 4 for the known set and the "
