...
detected" flag, not the metric angles (FINDINGS 11.10) — yet the pipeline pays
~100 ms per frame at ~6 students to run a full FaceLandmarker mesh, more than
the detector itself (FINDINGS 11.12). If a plain face *detector* preserves the
...
``head_down`` ones, and that **spread** is the signal (FINDINGS 11.15 measured
